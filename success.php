...
<body>
    ...
    <header class="header">
        <div class="container">
            <h3 class="header__title">Confirmación de orden</h3>
        </div>
    </header>
                ...
                <div class="main__top">
                    <div class="main__top-items">
                        <div class="main__top-item">
                            <p class="main__top-text">Su nombre:</p>
                            <span class="main__name" id="name"><?php echo ($name)?></span>
                        </div>
                        <div class="main__top-item">
                            <p class="main__top-text">Su número de teléfono:</p>
                ...
                <div class="main__bottom">
                    <div class="main__bottom-items">
                        <div class="main__bottom-item">
                            <p class="main__bottom-text">Proximamente el administrador se comunicará con usted, confirmará la disponibilidad del producto y responderá a sus preguntas</p>
                        ...
                        <div class="main__bottom-item">
                            <p class="main__bottom-text">Se puede pagar el producto al recibirlo</p>
    ...
    <footer class="footer">
        <div class="container">
            <h2 class="footer__title">Le agradecemos por su orden!</h2>
        </div>
    </footer>
